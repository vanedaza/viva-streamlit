...
def load_scalers_and_model():
    scaler_prior = joblib.load("Model_tl/scaler_prior_app6_Master_uni.save")
    scaler_spec  = joblib.load("Model_tl/scaler_spec_app6_Master_uni.save")
    with open("Model_tl/model_app6_TL_gau_Master.pkl", "rb") as f:
